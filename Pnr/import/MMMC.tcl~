...
create_constraint_mode -name func_mode -sdc_files {../dft/sdc/SYSTEM_func.sdc}
create_constraint_mode -name scan_mode -sdc_files {../dft/sdc/SYSTEM_scan.sdc}
create_constraint_mode -name capture_mode -sdc_files {../dft/sdc/SYSTEM_capture.sdc}
