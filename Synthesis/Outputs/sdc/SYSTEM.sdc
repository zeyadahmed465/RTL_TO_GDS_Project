...
# Created by write_sdc on Fri Sep 22 15:57:43 2023
...
create_clock [get_ports UART_CLK]  -name UARTCLK  -period 271  -waveform {0 135}
...
set_input_delay -clock RX_CLK  216.8  [get_ports UART_RX_IN]
set_output_delay -clock TX_CLK  1734.4  [get_ports UART_TX_OUT]
set_clock_groups -asynchronous -name REFCLK_1 -group [list [get_clocks REFCLK] [get_clocks ALU_CLK]] -group [list [get_clocks UARTCLK] [get_clocks TX_CLK]]
